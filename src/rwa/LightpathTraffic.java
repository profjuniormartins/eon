 ...
 *
 */
public class LightpathTraffic implements EventSubscriber {
	/** Serial version UID. */
	 ...
	 */
	public LightpathTraffic(int aMaxTries) {
	...
	public Object getContent() {
		...
		while(OBGPControlPlane.getDomain(target).equals(OBGPControlPlane.getDomain(source))) {
